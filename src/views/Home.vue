    ...
    <div class="app-wrapper">
      ...
      <section class="form-wrapper">
        <form action="#" method="POST">
          ...
          <p class="error-message">No results</p>
          <button type="submit" class="submit-btn">Search</button>
        </form>
      </section>

      <section class="card-wrapper">
        <img class="avatar desktop-avatar" src="@/assets/img/octocat.png" alt="Octocat" />

        <div class="card-contents">

          <div class="card-header">
            <img class="avatar mobile-avatar" src="@/assets/img/octocat.png" alt="Octocat" />

            <div class="user-text">
              <div class="username-info">
                <p class="username">The Octocat</p>
                <p class="github-username">@octocat</p>
              </div>
              <p class="joined-date">Joined 25 Jan 2011</p>
            </div>
          ...
          <div class="user-repo-wrapper">
            <div class="repo-block">
              ...
              <p class="repo-count">8</p>
            </div>
            <div class="repo-block">
              <p class="repo-title">Followers</p>
              <p class="repo-count">3938</p>
            </div>
            <div class="repo-block">
              <p class="repo-title">Following</p>
              <p class="repo-count">9</p>
            </div>
          </div>
